        ...
        <section className="max-w-7xl mx-auto px-4 container space-y-16">
            <div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
                  <p className="font-in-lato text-base md:text-4xl font-medium px-4 md:px-0 max-w-[600px] text-center md:text-left">Soluciones digitales para hacer crecer tu proyecto en salud.</p>
